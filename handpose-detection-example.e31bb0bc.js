...
const main = async () => {
  ...
  await tf.setBackend(state.backend); //Load the handpose model
...
const landmarksRealTime = async video => {
  ...
  ctx.strokeStyle = "red";
  ctx.fillStyle = "red"; //The below two statements are done, so that the camera view looks natural. else it will look like mirror view
  //Reset the point (0,0) to a given point

  ctx.translate(canvas.width, 0); //Flip the context horizontally
...
function drawKeypoints(ctx, keypoints) {
  ...
  for (let i = 0; i < keypointsArray.length; i++) {
    ...
    /* if(i!= 0 && i%4 == 0) {
        ...
        ctx.drawImage(img,90,130,50,60,y-12,x-40,25,50);
    } else {
        ctx.fillStyle = "red";
        drawPoint(ctx, x - 2, y - 2, 3);
    } */
...
main();
},{"@tensorflow/tfjs-core":"node_modules/@tensorflow/tfjs-core/dist/tf-core.esm.js","@tensorflow-models/handpose":"node_modules/@tensorflow-models/handpose/dist/handpose.esm.js"}]},{},["index.js"], null)
//# sourceMappingURL=/handpose-detection-example.e31bb0bc.js.map